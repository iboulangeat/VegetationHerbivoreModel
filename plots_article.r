...
plot_correlations <- function()
{
  ...
  axis(1, at = c(2, 5, 8, 11), labels = c("initial resilience", "asymptotic resilience", "exposure", "sensitivity"), tick =FALSE, cex.axis = 1.2)
  ...
  axis(1, at = c(2, 5, 8), labels = c("initial resilience", "asymptotic resilience", "exposure"), tick =FALSE, cex.axis = 1.2)
  ...
  axis(1, at = c(2, 5), labels = c("initial resilience", "asymptotic resilience"), tick =FALSE, cex.axis = 1.2)
...
##---MixedFeeder
plot_equilibrium_mf <- function(ylim.H=5)
{
  par(mfrow = c(1,3), cex = 1.2, mar = c(3,4,3,1))
  plot.template(xlim = c(0,50), ylim = c(0,1), xticks = c(6,11), yticks = c(6,11), xlab = "Temperature", ylab = "Vegetation proportion", col.bg = "white", col.grid = NA, plot.axis = F)
  lines(newEq.veg[,"T"]~gradient, col = colo()["T"], type = "l", lwd = 1.5)
  lines(newEq.veg[,"B"]~gradient, col = colo()["B"], type = "l", lwd = 1.5)
  lines(newEq.veg[,"R"]~gradient, col = colo()["R"], type = "l", lwd = 1.5)
